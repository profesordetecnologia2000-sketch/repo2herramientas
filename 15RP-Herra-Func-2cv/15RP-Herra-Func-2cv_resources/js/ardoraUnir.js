...
context.lineWidth=2.5;var posDivX=document.getElementById(sel1).parentNode.parentNode.offsetLeft+$("#"+sel1).width()+10;var posDivY=document.getElementById(sel1).offsetTop+13+5;
...
var posDivX=document.getElementById(join1[i]).parentNode.parentNode.offsetLeft+$("#"+join1[i]).width()+10;var posDivY=document.getElementById(join1[i]).offsetTop+13+5;}
else{var posX=document.getElementById(join1[i]).parentNode.parentNode.offsetLeft-5;var posY=document.getElementById(join1[i]).offsetTop+13+5;
var posDivX=document.getElementById(join2[i]).parentNode.parentNode.offsetLeft+$("#"+join2[i]).width()+10;var posDivY=document.getElementById(join2[i]).offsetTop+13+5;}
